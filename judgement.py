...
\n**Задачи:**
\n**1)** Ознакомиться теоритическими аспектами применения нейронных сетей в юриспруденции;
\n**2)** Попробовать применять прогнозную модель для разных вариантов судебных дел: выполняя задания лабораторной работы, проследить закономерности, которые наиболее влияют на решение предективной модели.
